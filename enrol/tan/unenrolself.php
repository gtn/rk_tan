...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'tan'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/tan/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_tan', format_string($course->fullname));
